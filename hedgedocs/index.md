...
<div style="margin-bottom: 2rem">
  <div style="margin: auto; width: fit-content;">
    ...
    <div style="display: inline-block; vertical-align: middle;">
      <h1 style="padding: 0 0 0 0.3rem; font-weight: 900; margin-bottom: -.2rem; font-size: xx-large;">Hedge<span style="font-weight: 200;">Docs</span></h1>
...
<div class="homepage-buttons">
  <a class="md-button md-button--primary homepage-link" href="tools/" style="text-align: center">
    Tools
  ...
  <a class="md-button md-button--primary homepage-link" href="guides/" style="text-align: center">
    Guides
  ...
  <a class="md-button md-button--primary homepage-link" href="docs/" style="text-align: center">
    Documentation
  ...
  <a class="md-button md-button--primary homepage-link" href="discoveries/" style="text-align: center">
    Discoveries
...
<div class="card">
  ...
  <div class="card-button">
    <a class="md-button md-button--primary homepage-link" href="https://discord.gg/yMz9nZTqVE" target="_blank" style="text-align: center; width: 17em; margin-left: auto; margin-top: auto; margin-bottom: auto">
      Join
